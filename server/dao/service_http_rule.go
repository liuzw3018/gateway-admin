...
func (hr *HttpRule) Find(c *gin.Context, tx *gorm.DB, search *HttpRule) (*HttpRule, error) {
	out := &HttpRule{}
...
func (hr *HttpRule) Save(c *gin.Context, tx *gorm.DB) error {
	return tx.WithContext(c).Save(hr).Error
}
