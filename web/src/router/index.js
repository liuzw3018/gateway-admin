    ...
    children: [
      {
        ...
        name: '租户列表',
        meta: { title: '租户列表', icon: 'el-icon-user-solid', affix: false }
      },
      {
        path: 'create_app',
        component: () => import('@/views/app/create_app'),
        name: '添加租户',
        hidden: true,
        meta: { title: '添加租户', icon: 'el-icon-user-solid', affix: false }
      },
      {
        path: 'edit_app/:id(\\d+)',
        component: () => import('@/views/app/create_app'),
        name: '修改租户',
        hidden: true,
        meta: { title: '修改租户', icon: 'el-icon-user-solid', affix: false }
      },
      {
        path: 'stat_app/:id(\\d+)',
        ...
        name: '租户统计',
        hidden: true,
        meta: { title: '租户统计', icon: 'el-icon-user-solid', affix: false }
      }
    ]
  }
]
